    ...
    return (
      ...
      <div className="dashboard-title">
        ...
        <div className="d-flex float-end">
                <button className="btn btn-primary me-3  mt-2" onClick={() => setView('received')}>Payments received</button>
                <button className="btn btn-primary me-3 mt-2" onClick={() => setView('done')}>Payments done</button>
            </div>
            <div>
            {view === 'received' ? <PaymentsReceivedTable /> : <PaymentsMadeTable />}
            </div>
